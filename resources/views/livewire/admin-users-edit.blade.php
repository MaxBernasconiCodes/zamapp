...
<div class="font-roboto rounded-3xl grid grid-cols sm:grid-cols-2 xl:grid-cols-12  gap-y-2 gap-x-3 my-4 mx-auto lg:w-4/5 md:w-full p-2  bg-zam-light">
        <!--Titulo-->
        ...
        <div class="grid md:col-span-1 xl:col-span-2 row-span-2 py-2">
            ...
            <label  class="rounded-lg shadow-lg md:max-w-sm" > {{$email}} </label>
        </div>
        <div class="grid md:col-span-1 xl:col-span-2 row-span-2 py-2">
        ...
        <div class="grid md:col-span-1 xl:col-span-2 row-span-2 py-2"></div>
        <div class="grid md:col-span-1 xl:col-span-2 row-span-2 py-2"></div>
