<div wire:click="hide" class=" {{$hidden}} cursor-pointer mb-1 -mt-6 shadow-sm flex justify-between bg-green-800 bg-{{$color}}-800 text-white text-sm font-bold px-4 py-3" role="alert">
