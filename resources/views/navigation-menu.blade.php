<nav x-data="{ open: false }" class="bg-zam-dark border-b border-zam-light ">
                    ...
                    <div class="ml-3 relative">
                        <x-jet-dropdown align="right" width="60">
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    <!-- Team Management -->
                                    <div class="block px-4 py-2 text-xs text-zam-dark">
                                        {{ __('Manage Team') }}
                                    </div>
                                    ...
                                    <div class="border-t border-zam-gray"></div>
